                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.system-settings.update", [$systemSetting->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $systemSetting->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $systemSetting->type) }}">
                            @if($errors->has('type'))
                        ...
                        <div class="form-group {{ $errors->has('key') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="key" id="key" value="{{ old('key', $systemSetting->key) }}" required>
                            @if($errors->has('key'))
                        ...
                        <div class="form-group {{ $errors->has('value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="value" id="value" value="{{ old('value', $systemSetting->value) }}">
                            @if($errors->has('value'))
