        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.bookLoan.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.book-loans.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('expired_pay') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="expired_pay" id="expired_pay" value="1" {{ old('expired_pay', 0) == 1 ? 'checked' : '' }}>
